...
export default function UserList({ user }) {
  ...
  return (
    <div className=" w-screen px-3 bg-white rounded-md p-2 mb-4 shadow text-xs md:max-w-lg md:text-base ">
      ...
      <div className="flex flex-col items-center w-full px-4">
        ...
        <div className="w-full flex justify-between md:w-4/6 md:justify-between mb-2 shadow h-44">
          <span className="text-right font-medium">{bio}</span>
        </div>
      </div>
    </div>
  );
